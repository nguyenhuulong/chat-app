import { Avatar, IconButton, Tooltip, Button, Dialog, DialogTitle, DialogContent, DialogActions, DialogContentText, TextField } from '@mui/material'
...
const Sidebar = () => {
  ...
  return (
    <StyledContainer>
        ...
        <Dialog open={isOpenNewConversationDialog} onClose={closeConversationDialog}>
